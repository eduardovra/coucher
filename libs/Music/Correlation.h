...
namespace Music
{
	//! do a correlation with a specific wave-length of a desired note
	struct Correlation
	{
		 ...
		 */
		Correlation(double latency_factor, int ht);
	...
	struct RangedCorrelation
	{
		 ...
		 * \param ht analysed semi-tone (-48;+48)
		 */
		RangedCorrelation(double pitch_tolerance, double latency_factor, int ht);
